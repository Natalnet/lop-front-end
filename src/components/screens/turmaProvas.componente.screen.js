                        ...
                        <Card key={prova.id} className="mb-2">
                            ...
                            <CardOptions>
                                ...
                                (profile==="professor") && participant?(
                                    <Link to={`/professor/turma/${props.match.params.id}/participantes/${user.id}/provas/${prova.id}/exercicios`}
                                        >
                                ...
                                (profile==="professor") ?(
                                    <>
                                    <Link to={`/professor/turma/${props.match.params.id}/prova/${prova.id}`}>
                                        <button className="btn btn-success mr-2">
                                            Acessar <i className="fa fa-wpexplorer" />
                                        </button>
                                    </Link>
                                    <button className="btn btn-danger" onClick={()=>removerProva(prova)}>
